...
export default function ManajemenRisikoAgribisnisPage() {
  const article = getArticleBySlug("manajemen-risiko-agribisnis");
  ...
  return (
    <>
      ...
      {article && (
        <BreadcrumbJsonLd
          items={[
            ...
            { name: article.title, href: `/artikel/manajemen-risiko-agribisnis` },
          ]}
        />
      )}
      ...
      <div className="relative h-[400px] lg:h-[600px] bg-gray-100">
        <Image
          src="/images/manajemen-risiko-hero.webp"
          alt="Manajemen Risiko Agribisnis - Diskusi Petani Senior dan Analis Muda dengan Laptop di Saung Bambu"
          fill
