...
export default function AdaptasiPerubahanIklimArtikelPage() {
  const article = getArticleBySlug("adaptasi-perubahan-iklim");
      ...
      {article && (
        <BreadcrumbJsonLd
          items={[
            ...
            { name: article.title, href: `/artikel/adaptasi-perubahan-iklim` },
          ]}
        />
      )}
      <FaqJsonLd faqs={articleFaqs["adaptasi-perubahan-iklim"] || []} />
